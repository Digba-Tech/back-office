...
export const fr: LocaleShape<typeof en> = {
  ...
  login: {
    ...
    description: "Connectez-vous à votre compte administrateur.",
    emailLabel: "E-mail",
    ...
    signInNotAllowed: "La connexion n'est pas autorisée pour ce compte actuellement.",
    toggleToSignUp: "Pas de compte ? Inscrivez-vous",
    toggleToSignIn: "Vous avez déjà un compte ? Connectez-vous",
    signUpTitle: "Créer un compte administrateur",
    signUpDescription: "Choisissez votre propre mot de passe — il n'y a pas de mot de passe temporaire défini par l'équipe ops.",
    confirmPasswordLabel: "Confirmer le mot de passe",
    signUp: "S'inscrire",
    signingUp: "Création du compte…",
    passwordMinLength: "Au moins 8 caractères",
    passwordMismatch: "Les mots de passe ne correspondent pas",
    signUpNotAllowed: "L'inscription n'est pas autorisée pour cet e-mail actuellement.",
    signUpFailedFallback: "Nécessite votre attention — échec de l'inscription. Réessayez.",
  },
  verifyEmail: {
    title: "Vérifiez votre e-mail",
    description:
      "Nous avons envoyé un lien de vérification à {{email}}. Cliquez dessus pour continuer — cette application ne fonctionnera pas tant que votre e-mail n'est pas vérifié.",
    descriptionNoEmail: "Cliquez sur le lien de vérification que nous vous avons envoyé pour continuer.",
    resend: "Renvoyer l'e-mail de vérification",
    resending: "Envoi…",
    resendSuccess: "E-mail de vérification envoyé — vérifiez votre boîte de réception.",
    resendAlreadyVerified: "Cet e-mail est déjà vérifié — essayez d'actualiser la page.",
    resendFailedFallback: "Nécessite votre attention — impossible d'envoyer l'e-mail de vérification. Réessayez.",
    verifying: "Vérification de votre e-mail…",
    verifyFailedInvalidToken:
      "Ce lien de vérification est invalide ou a expiré. Demandez-en un nouveau ci-dessous.",
    verifyFailedFallback: "Nécessite votre attention — impossible de vérifier votre e-mail. Réessayez.",
    continueButton: "J'ai vérifié — continuer",
  ...
  requirements: {
    ...
    detail: {
      ...
      editLocked: "Cette exigence est {{status}} et ne peut plus être modifiée.",
      actions: {
        title: "Actions (niveau 2)",
        info: "Tâches concrètes qu'une coopérative doit accomplir pour cette exigence. Affichées à la coopérative comme son plan d'action.",
      ...
      evidenceChecklist: {
        title: "Liste de preuves (niveau 3)",
        info: "Documents/preuves fournis par une coopérative pour montrer que les actions ci-dessus ont bien été réalisées.",
        empty: "Aucun élément de preuve pour le moment.",
        add: "Ajouter un élément de preuve",
        remove: "Supprimer l'élément",
        nameLabel: "Nom",
        weightLabel: "Poids",
        documentTypesLabel: "Types de documents acceptés",
  ...
  api: {
    ...
    verificationRequired: "Votre e-mail doit être vérifié avant de pouvoir faire cela.",
