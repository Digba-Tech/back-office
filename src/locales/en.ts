...
export const en = {
  ...
  login: {
    ...
    signInNotAllowed: "Sign-in isn't allowed for this account right now.",
    toggleToSignUp: "Need an account? Sign up",
    toggleToSignIn: "Already have an account? Sign in",
    signUpTitle: "Create an admin account",
    signUpDescription: "Choose your own password — there's no ops-set temporary one.",
    confirmPasswordLabel: "Confirm password",
    signUp: "Sign up",
    signingUp: "Creating account…",
    passwordMinLength: "At least 8 characters",
    passwordMismatch: "Passwords don't match",
    signUpNotAllowed: "Sign-up isn't allowed for this email right now.",
    signUpFailedFallback: "Requires attention — sign-up failed. Try again.",
  },
  verifyEmail: {
    title: "Verify your email",
    description:
      "We sent a verification link to {{email}}. Click it to continue — this app won't work until your email is verified.",
    descriptionNoEmail: "Click the verification link we emailed you to continue.",
    resend: "Resend verification email",
    resending: "Sending…",
    resendSuccess: "Verification email sent — check your inbox.",
    resendAlreadyVerified: "This email is already verified — try refreshing the page.",
    resendFailedFallback: "Requires attention — couldn't send the verification email. Try again.",
    verifying: "Verifying your email…",
    verifyFailedInvalidToken:
      "This verification link is invalid or has expired. Request a new one below.",
    verifyFailedFallback: "Requires attention — couldn't verify your email. Try again.",
    continueButton: "I've verified — continue",
  ...
  requirements: {
    ...
    detail: {
      ...
      editLocked: "This requirement is {{status}} and can no longer be edited.",
      actions: {
        title: "Actions (Level 2)",
        info: "Concrete to-dos a cooperative must complete for this requirement. Shown to cooperatives as their action plan.",
      ...
      evidenceChecklist: {
        title: "Evidence checklist (Level 3)",
        info: "Documents/proof a cooperative provides to show the actions above were actually carried out.",
        empty: "No evidence items yet.",
        add: "Add evidence item",
        remove: "Remove evidence item",
        nameLabel: "Name",
        weightLabel: "Weight",
        documentTypesLabel: "Accepted document types",
  ...
  api: {
    ...
    verificationRequired: "Your email needs to be verified before you can do that.",
